...
* Place the transmitter and receiver in line of sight.
...
Set up the photodiode/APD to detect the optical signal.

* Mount the detector opposite to the transmitter.
* Connect it to an oscilloscope for signal observation.
...
* Vary the distance between the transmitter and receiver, such as 1 m, 5 m, 10 m, etc.
* Note the received power in µW.
* Calculate the link loss using:
...
Visualize the performance of the FSO link.

* Plot **Received Power vs Distance**.
* Observe the decay in received power as distance increases.
* Compare the experimental/simulated results with the theoretical model.
...
* Reliable communication can be achieved up to approximately 10 m indoors under suitable conditions.
* Link loss increases as the transmission distance increases.
* Proper transmitter-receiver alignment is critical for good communication performance.
...
## Output
<img width="652" height="217" alt="image" src="https://github.com/user-attachments/assets/8ca7e054-138d-4bc8-bbc1-75349f50a17a" />
